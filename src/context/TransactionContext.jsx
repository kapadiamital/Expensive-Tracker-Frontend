...
export const TransactionProvider = ({ children }) => {
  ...
  const fetchTransactions = useCallback(async (forceRefresh = false) => {
    ...
    try {
      ...
      // Sort transactions by date in descending order (LIFO)
  ...
  const addTransaction = useCallback(async (transactionData) => {
    try {
      ...
      setAllTransactions((prev) => {
        ...
        // Sort after adding a new transaction
  ...
  const updateTransaction = useCallback(async (id, transactionData) => {
    try {
      ...
      setAllTransactions((prev) => {
        const updatedTransactions = prev.map((t) => (t._id === id ? response.data : t));
        // Sort after updating a transaction
        return updatedTransactions.sort((a, b) => {
          const dateA = new Date(a.date);
          const dateB = new Date(b.date);
          return dateB - dateA;
